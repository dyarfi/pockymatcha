...
class Question extends Admin_Controller {
    ...
    public function index() {
        try {
            ...
            //$crud->callback_field('modified', array($this, '_callback_modified'));
            $crud->callback_field('added', array($this, '_callback_added'));
...
//            $crud->display_as('total_image', 'Total Image Submitted');
            ...
            // Set upload field
            $crud->set_field_upload('file_name','uploads/questionnaire/questions');
